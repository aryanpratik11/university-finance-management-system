        ...
        const fetchData = async () => {
            try {
                ...
                setStats({
                    ...
                    totalPayroll: data.payroll.reduce((sum, p) => sum + p.total_amount, 0)
                });
            } catch (err) {
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <div className="mb-8">
                    ...
                    <p className="text-gray-600 mt-1">
                        {data.budget.name || "Department"} financial overview
                    </p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
                    <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
                        ...
                        <p className="mt-2 text-3xl font-bold text-blue-900">
                            ₹{data.budget.budget?.toLocaleString() || 0}
                        </p>
                    </div>
                    ...
                    <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
                        ...
                        <p className={`mt-2 text-3xl font-bold ${
                            stats.remainingBudget < 0 ? 'text-red-600' : 'text-green-600'
                        }`}>
                    ...
                    <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
                        ...
                        <p className="text-sm text-gray-500 mt-1">
                            {data.grants.length} total grants
                        </p>
                    </div>
                </div>
                ...
                <div className="bg-white rounded-xl shadow-sm border border-gray-200 mb-8 overflow-hidden">
                    <div className="p-6 border-b border-gray-200 flex justify-between items-center">
                        <div>
                            ...
                            <p className="text-sm text-gray-500 mt-1">
                                {data.pendingExpenses.length} requests awaiting your approval
                            </p>
                        </div>
                    </div>
                ...
                <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                    <div className="p-6 border-b border-gray-200">
                        ...
                        <p className="text-sm text-gray-500 mt-1">
                            {data.payroll.length} months of payroll data
                        </p>
                    </div>
                                ...
                                <tbody className="bg-white divide-y divide-gray-200">
                                    {data.payroll.map((p) => (
                                        <tr key={p.month} className="hover:bg-gray-50">
                                            ...
                                            <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                                {((p.total_amount / data.budget.budget) * 100).toFixed(1)}%
                                            </td>
                                        </tr>
                                    ))}
                                </tbody>
